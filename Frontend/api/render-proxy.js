...
const ALLOWED_PATH =
  /^v1\/player(\?.*)?$|^v1\/youtube\/highlight(\?.*)?$|^v1\/epl\/(season-matches|league-table|normalized-matches|matchday-data)(\?.*)?$|^v1\/match-data\/(pl_matches_2024_25|football_data_E0_2526|football_data_E0_2627|premier_league_stats_2024_25)\.csv$/;
